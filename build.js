...
/* Theme generation */
shell.cp('_theming.scss', `${NPM_DIR}`);
shell.cp('_material-theme.scss', `${NPM_DIR}`);
cpx.copySync('./src/**/*.scss', `${NPM_DIR}/src`);
shell.exec(`node_modules/.bin/node-sass --importer=node_modules/node-sass-tilde-importer _material-theme.scss > ${NPM_DIR}/material-theme.css`);
